    ...
    <div class="card">
        ...
        <form name="signup_form" ng-submit="User.signup()">
            <div class="input-group">
                <label>用户名</label>
                <input type="text" name="username" ng-minlength="2" ng-maxlength="24"
                ...
                <div ng-if="signup_form.username.$touched" class="input-error-set">
                    ...
                    <div ng-if="signup_form.username.$error.maxlength ||
                        signup_form.username.$error.minlength">用户名长度需在2到24位之间</div>
                    <div ng-if="User.signup_username_exists">用户名已存在</div>
                </div>
            </div>
            <div class="input-group">
                <label>密码</label>
                <input type="password" name="password" ng-minlength="6" ng-maxlength="255"
                ...
                <div ng-if="signup_form.password.$touched" class="input-error-set">
                    ...
                    <div ng-if="signup_form.password.$error.maxlength ||
                        signup_form.password.$error.minlength">密码长度需在6到255位之间</div>
                </div>
            </div>
            <div class="input-group">
                    <label>用户介绍</label>
                    <input type="type" name="intro" ng-model="User.signup_data.intro">
            </div>
